...
public enum Action {
    ...
    localParameterCanBeFinal("Add final to parameter variable", false),

    foreachParameterCanBeFinal("Add final to foreach parameter variable", false),

    catchParameterCanBeFinal("Add final to catch parameter variable", false),
    ...
    Action(final String text, final boolean defaultValue) {
        this.text = text;
